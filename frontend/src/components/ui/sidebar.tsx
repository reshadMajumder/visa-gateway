    ...
    return (
      <aside
        ...
        className={cn(
            ...
            open ? "w-[--sidebar-width]" : "w-[calc(var(--sidebar-width-icon)_+2rem)]",
            className
        )}
        data-state={state}
        {...props}
    ...
    return (
      <Tooltip>
        ...
        <TooltipContent
          side="right"
          align="center"
          hidden={state !== "collapsed" || isMobile || open}
          {...tooltip}
        />
      </Tooltip>
    )
